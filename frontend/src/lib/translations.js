...
export const translations = {
  en: {
    ...
    placeholderAnalyze: 'Search by company, alias, or ticker',
    placeholderCompare: 'Search and add 2–5 companies',
    working: 'Working…',
    analyzeCta: 'Build research brief',
    compareCta: 'Compare companies',
    vEnterCompany: 'Search for a company or enter a ticker to begin.',
    vSelectCompany: 'Select a company from the results, or enter its exact ticker.',
    vCompareCount: 'Select between two and five companies to compare.',
    vDuplicate: 'That company is already selected.',
    vCompareFull: 'You can compare up to five companies at a time.',
    searchLoading: 'Searching companies…',
    searchEmpty: 'No supported companies found. You can still enter an exact ticker.',
    searchError: 'Company search is temporarily unavailable. Exact ticker entry still works.',
    searchResultCount: '{count} company matches found.',
    searchResultsLabel: 'Company search results',
    didYouMean: 'Did you mean',
    selectedCompanies: 'Selected companies',
    removeCompany: 'Remove {company}',
    unknownSector: 'Sector unavailable',
    matchExactTicker: 'Exact ticker',
    matchExactName: 'Exact company name',
    matchPrefix: 'Name starts with',
    matchPartial: 'Partial name match',
    matchAlias: 'Common alias',
    matchLocalizedAlias: 'Localized alias',
    matchFuzzy: 'Close spelling match',
    ...
    analysisViewAria: 'Choose research view',
    personalizedView: 'Personalized View',
    neutralEvidenceView: 'Neutral Evidence View',
    personalizedInterpretation: 'Personalized interpretation',
    policyFit: 'Policy fit',
    matchedPreferences: 'matched preferences',
    failedPreferences: 'failed preferences',
    hardConstraints: 'hard constraints checked',
  ...
  es: {
    ...
    placeholderAnalyze: 'Busca por empresa, alias o ticker',
    placeholderCompare: 'Busca y añade de 2 a 5 empresas',
    working: 'Trabajando…',
    analyzeCta: 'Crear informe de análisis',
    compareCta: 'Comparar empresas',
    vEnterCompany: 'Busca una empresa o escribe un ticker para empezar.',
    vSelectCompany: 'Selecciona una empresa de los resultados o escribe su ticker exacto.',
    vCompareCount: 'Selecciona entre dos y cinco empresas para comparar.',
    vDuplicate: 'Esa empresa ya está seleccionada.',
    vCompareFull: 'Puedes comparar hasta cinco empresas a la vez.',
    searchLoading: 'Buscando empresas…',
    searchEmpty: 'No se encontraron empresas compatibles. Aún puedes escribir un ticker exacto.',
    searchError: 'La búsqueda no está disponible temporalmente. La entrada directa de ticker sigue funcionando.',
    searchResultCount: 'Se encontraron {count} coincidencias.',
    searchResultsLabel: 'Resultados de búsqueda de empresas',
    didYouMean: '¿Quizás quisiste decir',
    selectedCompanies: 'Empresas seleccionadas',
    removeCompany: 'Eliminar {company}',
    unknownSector: 'Sector no disponible',
    matchExactTicker: 'Ticker exacto',
    matchExactName: 'Nombre exacto',
    matchPrefix: 'El nombre empieza por',
    matchPartial: 'Coincidencia parcial',
    matchAlias: 'Alias común',
    matchLocalizedAlias: 'Alias localizado',
    matchFuzzy: 'Ortografía aproximada',
    ...
    analysisViewAria: 'Elegir vista de análisis',
    personalizedView: 'Vista personalizada',
    neutralEvidenceView: 'Vista de evidencia neutral',
    personalizedInterpretation: 'Interpretación personalizada',
    policyFit: 'Ajuste a la política',
    matchedPreferences: 'preferencias cumplidas',
    failedPreferences: 'preferencias no cumplidas',
    hardConstraints: 'restricciones obligatorias revisadas',
  ...
  fr: {
    ...
    placeholderAnalyze: 'Rechercher par société, alias ou ticker',
    placeholderCompare: 'Rechercher et ajouter 2 à 5 sociétés',
    working: 'En cours…',
    analyzeCta: 'Créer la note de recherche',
    compareCta: 'Comparer les sociétés',
    vEnterCompany: 'Recherchez une société ou saisissez un ticker pour commencer.',
    vSelectCompany: 'Sélectionnez une société dans les résultats ou saisissez son ticker exact.',
    vCompareCount: 'Sélectionnez entre deux et cinq sociétés à comparer.',
    vDuplicate: 'Cette société est déjà sélectionnée.',
    vCompareFull: 'Vous pouvez comparer jusqu’à cinq sociétés à la fois.',
    searchLoading: 'Recherche de sociétés…',
    searchEmpty: 'Aucune société prise en charge trouvée. Vous pouvez toujours saisir un ticker exact.',
    searchError: 'La recherche est temporairement indisponible. La saisie directe d’un ticker fonctionne toujours.',
    searchResultCount: '{count} correspondances trouvées.',
    searchResultsLabel: 'Résultats de recherche de sociétés',
    didYouMean: 'Vouliez-vous dire',
    selectedCompanies: 'Sociétés sélectionnées',
    removeCompany: 'Retirer {company}',
    unknownSector: 'Secteur indisponible',
    matchExactTicker: 'Ticker exact',
    matchExactName: 'Nom exact',
    matchPrefix: 'Le nom commence par',
    matchPartial: 'Correspondance partielle',
    matchAlias: 'Alias courant',
    matchLocalizedAlias: 'Alias localisé',
    matchFuzzy: 'Orthographe proche',
    ...
    analysisViewAria: 'Choisir la vue de recherche',
    personalizedView: 'Vue personnalisée',
    neutralEvidenceView: 'Vue des preuves neutres',
    personalizedInterpretation: 'Interprétation personnalisée',
    policyFit: 'Adéquation à la politique',
    matchedPreferences: 'préférences satisfaites',
    failedPreferences: 'préférences non satisfaites',
    hardConstraints: 'contraintes strictes vérifiées',
  ...
  zh: {
    ...
    placeholderAnalyze: '按公司、别名或股票代码搜索',
    placeholderCompare: '搜索并添加 2–5 家公司',
    working: '处理中…',
    analyzeCta: '生成研究简报',
    compareCta: '对比公司',
    vEnterCompany: '请搜索公司或输入股票代码开始。',
    vSelectCompany: '请从结果中选择公司，或输入准确的股票代码。',
    vCompareCount: '请选择两到五家公司进行对比。',
    vDuplicate: '该公司已被选中。',
    vCompareFull: '一次最多可对比五家公司。',
    searchLoading: '正在搜索公司…',
    searchEmpty: '未找到支持的公司。你仍可输入准确的股票代码。',
    searchError: '公司搜索暂时不可用，但仍可直接输入股票代码。',
    searchResultCount: '找到 {count} 个公司结果。',
    searchResultsLabel: '公司搜索结果',
    didYouMean: '你是不是想找',
    selectedCompanies: '已选公司',
    removeCompany: '移除 {company}',
    unknownSector: '行业板块未知',
    matchExactTicker: '股票代码完全匹配',
    matchExactName: '公司名称完全匹配',
    matchPrefix: '名称前缀匹配',
    matchPartial: '公司名称部分匹配',
    matchAlias: '常用别名匹配',
    matchLocalizedAlias: '本地化别名匹配',
    matchFuzzy: '近似拼写匹配',
    ...
    analysisTitle: '风险与机会',
    analysisViewAria: '选择研究视图',
    personalizedView: '个性化视图',
    neutralEvidenceView: '中性证据视图',
    personalizedInterpretation: '个性化解读',
    policyFit: '政策匹配度',
    matchedPreferences: '项偏好已匹配',
    failedPreferences: '项偏好未匹配',
    hardConstraints: '项硬性约束已检查',
